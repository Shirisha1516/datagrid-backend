...
import com.tml.AIP_POSITION_JDG_TRANS.controller.MyJdgPositionUIController;
...
@RestController
@RequestMapping(path = "/api/crm/custom")
public class MyJdgPositionUIController {

	private static Logger logger = LoggerFactory.getLogger(MyJdgPositionUIController.class);
	@Autowired
	...
	public List<PositionUIResponse> getData() throws Exception {
		List<PositionUIResponse> PositionUIList = null;
			...
			if(PositionUIList.isEmpty() || PositionUIList==null) {
   ...
   public Set<PositionUIResponse> searchNew(@RequestBody HashMap<String, String> paramMap) throws Exception{
